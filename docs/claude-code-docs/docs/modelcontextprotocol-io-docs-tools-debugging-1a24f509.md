...
source_url: "https://modelcontextprotocol.io/docs/tools/debugging"
host: "modelcontextprotocol.io"
depth: 1
selector: "article,main,[role=main]"
fetched_at: "2026-07-12T00:15:42.371Z"
---
...
3.  **Client developer tools**: most MCP clients expose logs and connection state. See [Debugging in Claude Desktop](https://modelcontextprotocol.io/docs/tools/debugging#debugging-in-claude-desktop) below for one example, or consult your client’s documentation.
