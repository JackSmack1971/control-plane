...
fetched_at: "2026-07-12T00:15:35.474Z"
---
...
](https://code.claude.com/docs/en/third-party-integrations#compare-deployment-options)
...
For a feature-by-feature breakdown of what’s available on each option, see [Feature availability](https://code.claude.com/docs/en/feature-availability). Select a deployment option to view setup instructions:
...
](https://code.claude.com/docs/en/third-party-integrations#amazon-bedrock)
...
](https://code.claude.com/docs/en/third-party-integrations#microsoft-foundry)
...
](https://code.claude.com/docs/en/third-party-integrations#google-cloud%E2%80%99s-agent-platform)
...
](https://code.claude.com/docs/en/third-party-integrations#best-practices-for-organizations)
...
](https://code.claude.com/docs/en/third-party-integrations#invest-in-documentation-and-memory)
...
](https://code.claude.com/docs/en/third-party-integrations#simplify-deployment)
...
](https://code.claude.com/docs/en/third-party-integrations#start-with-guided-usage)
...
](https://code.claude.com/docs/en/third-party-integrations#pin-model-versions-for-cloud-providers)
...
](https://code.claude.com/docs/en/third-party-integrations#configure-security-policies)
...
](https://code.claude.com/docs/en/third-party-integrations#leverage-mcp-for-integrations)
...
](https://code.claude.com/docs/en/third-party-integrations#next-steps)
...
[Auto mode](https://code.claude.com/docs/en/auto-mode-config)[Feature availability](https://code.claude.com/docs/en/feature-availability)
