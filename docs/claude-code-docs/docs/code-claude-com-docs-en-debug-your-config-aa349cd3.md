...
fetched_at: "2026-07-12T00:15:44.903Z"
---
...
| `/doctor` | Setup checkup: installation health, invalid settings files, unused extensions, and duplicate [subagent](https://code.claude.com/docs/en/sub-agents) names in the same directory, with proposed fixes |
