...
source_url: "https://modelcontextprotocol.io/docs/develop/build-with-agent-skills"
host: "modelcontextprotocol.io"
depth: 1
selector: "article,main,[role=main]"
fetched_at: "2026-07-12T00:15:41.452Z"
---
...
A reference set of MCP development skills is available as the [`mcp-server-dev` plugin](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/mcp-server-dev). It provides three composing skills:
...
For other agents, check your skills or extensions catalog, or clone the [skill directories](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/mcp-server-dev/skills) (`SKILL.md` plus `references/`) into your agent’s skills location.
...
-   **User interaction needs** — plain text results, structured input via [elicitation](https://modelcontextprotocol.io/specification/draft/client/elicitation), or rich UI widgets
...
[Connect to remote MCP Servers](https://modelcontextprotocol.io/docs/develop/connect-remote-servers)[Build an MCP server](https://modelcontextprotocol.io/docs/develop/build-server)
