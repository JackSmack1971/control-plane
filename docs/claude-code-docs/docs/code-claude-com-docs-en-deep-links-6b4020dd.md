...
fetched_at: "2026-07-12T00:15:44.556Z"
---
...
This page covers how to [build a link](https://code.claude.com/docs/en/deep-links#build-a-link), [embed one in a runbook or trigger it from the shell](https://code.claude.com/docs/en/deep-links#examples), and [manage or disable handler registration](https://code.claude.com/docs/en/deep-links#registration-and-supported-platforms) on each platform.
...
](https://code.claude.com/docs/en/deep-links#how-it-works)
...
The link itself can be hosted anywhere, but the session always opens locally on the computer where you clicked. See [Registration and supported platforms](https://code.claude.com/docs/en/deep-links#registration-and-supported-platforms) for which terminal emulator opens on each operating system.

The platform that displays the link must allow custom URL schemes. GitHub-rendered Markdown allows `http` and `https` but strips schemes like `claude-cli://` in READMEs, issues, pull requests, and wikis. Only the link text shows, with no link behind it and the URL hidden. See [Troubleshooting](https://code.claude.com/docs/en/deep-links#the-link-renders-as-plain-text-instead-of-being-clickable) for a workaround.

###

[​

](https://code.claude.com/docs/en/deep-links#what-a-launched-session-shows)
...
](https://code.claude.com/docs/en/deep-links#build-a-link)
...
`cwd` and `repo` are [two ways to set the working directory](https://code.claude.com/docs/en/deep-links#choose-between-cwd-and-repo). If you pass both, `cwd` takes precedence and `repo` is ignored, even if the `cwd` path does not exist. The following link points at a repository called `acme/payments` with a two-line diagnostic prompt. Replace `acme/payments` with your repository’s `owner/name` slug when you build your own:
...
](https://code.claude.com/docs/en/deep-links#examples)
...
](https://code.claude.com/docs/en/deep-links#open-a-link-from-the-shell)
...
](https://code.claude.com/docs/en/deep-links#registration-and-supported-platforms)
...
](https://code.claude.com/docs/en/deep-links#troubleshooting)
...
](https://code.claude.com/docs/en/deep-links#clicking-the-link-does-nothing)
...
](https://code.claude.com/docs/en/deep-links#the-link-renders-as-plain-text-instead-of-being-clickable)
...
](https://code.claude.com/docs/en/deep-links#the-session-opens-in-my-home-directory-instead-of-the-repo)
...
](https://code.claude.com/docs/en/deep-links#the-link-opens-the-wrong-terminal)
...
](https://code.claude.com/docs/en/deep-links#learn-more)
...
[Programmatic usage](https://code.claude.com/docs/en/headless)[Monorepos and large repos](https://code.claude.com/docs/en/large-codebases)
