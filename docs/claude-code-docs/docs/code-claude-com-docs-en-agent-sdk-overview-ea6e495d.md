...
fetched_at: "2026-07-12T00:15:31.486Z"
---
...
](https://code.claude.com/docs/en/agent-sdk/overview#capabilities)
...
](https://code.claude.com/docs/en/agent-sdk/overview#claude-code-features)
...
](https://code.claude.com/docs/en/agent-sdk/overview#compare-the-agent-sdk-to-other-claude-tools)
...
](https://code.claude.com/docs/en/agent-sdk/overview#changelog)
...
](https://code.claude.com/docs/en/agent-sdk/overview#reporting-bugs)
...
](https://code.claude.com/docs/en/agent-sdk/overview#next-steps)
