...
fetched_at: "2026-07-12T00:15:44.233Z"
---
...
](https://code.claude.com/docs/en/goal#use-/goal)
...
](https://code.claude.com/docs/en/goal#set-a-goal)
...
](https://code.claude.com/docs/en/goal#check-status)
...
](https://code.claude.com/docs/en/goal#clear-a-goal)
...
](https://code.claude.com/docs/en/goal#resume-with-an-active-goal)
...
](https://code.claude.com/docs/en/goal#run-non-interactively)
...
](https://code.claude.com/docs/en/goal#requirements)
...
](https://code.claude.com/docs/en/goal#see-also)
