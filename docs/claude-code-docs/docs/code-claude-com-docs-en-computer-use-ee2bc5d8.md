...
fetched_at: "2026-07-12T00:15:34.745Z"
---
...
When Claude acquires the lock, a macOS notification appears: “Claude is using your computer · press Esc to stop.” Press `Esc` anywhere to abort the current action immediately, or press `Ctrl+C` in the terminal. Either way, Claude stops, unhides your apps, and returns control to you. The session keeps the [computer use lock](https://code.claude.com/docs/en/computer-use#one-session-at-a-time) until it exits. A second notification appears when Claude is done.
...
[Chrome extension](https://code.claude.com/docs/en/chrome)[Visual Studio Code](https://code.claude.com/docs/en/vs-code)
