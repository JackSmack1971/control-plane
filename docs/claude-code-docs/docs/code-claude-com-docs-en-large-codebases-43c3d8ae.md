...
fetched_at: "2026-07-12T00:15:44.724Z"
---
...
](https://code.claude.com/docs/en/large-codebases#what-this-guide-covers)
...
](https://code.claude.com/docs/en/large-codebases#settings-on-this-page)
...
| I want to | Use |
| --- | --- |
| Load only the conventions for the code you touch, instead of one root file covering every subsystem | Per-directory [CLAUDE.md files](https://code.claude.com/docs/en/large-codebases#layer-claude-md-files-by-directory) |
| Exclude CLAUDE.md files for packages you never work in | [`claudeMdExcludes`](https://code.claude.com/docs/en/large-codebases#exclude-irrelevant-claude-md-files) |
| Block Claude from opening build output, generated code, and vendored dependencies | [`Read` deny rules](https://code.claude.com/docs/en/large-codebases#block-reads-of-generated-and-vendored-code) in `permissions.deny` |
| Find a symbol’s definition or callers through the language server instead of scanning files | A [code intelligence plugin](https://code.claude.com/docs/en/large-codebases#reduce-file-reads-with-code-intelligence) |
| Check out only the directories a task needs when Claude creates a worktree | [`worktree.sparsePaths`](https://code.claude.com/docs/en/large-codebases#check-out-only-the-directories-you-need) |
| Read and edit a sibling package or another repository from the same session | [`--add-dir`](https://code.claude.com/docs/en/large-codebases#grant-access-across-packages-or-repositories) or `additionalDirectories` |
| Give Claude procedures specific to one area that load only when relevant | Per-directory [skills](https://code.claude.com/docs/en/large-codebases#add-per-directory-skills) |
| Replace many per-directory CLAUDE.md files with one set of conventions everyone installs | A [plugin](https://code.claude.com/docs/en/large-codebases#centralize-conventions-when-layering-stops-scaling) in an internal marketplace |
...
](https://code.claude.com/docs/en/large-codebases#the-example-monorepo)
...
](https://code.claude.com/docs/en/large-codebases#layer-claude-md-files-by-directory)
...
](https://code.claude.com/docs/en/large-codebases#choose-between-per-directory-claude-md-and-path-scoped-rules)
...
](https://code.claude.com/docs/en/large-codebases#exclude-irrelevant-claude-md-files)
...
](https://code.claude.com/docs/en/large-codebases#reduce-what-claude-reads)
...
](https://code.claude.com/docs/en/large-codebases#grant-access-across-packages-or-repositories)
...
](https://code.claude.com/docs/en/large-codebases#add-per-directory-skills)
...
](https://code.claude.com/docs/en/large-codebases#keep-skills-discoverable)
...
](https://code.claude.com/docs/en/large-codebases#centralize-conventions-when-layering-stops-scaling)
...
](https://code.claude.com/docs/en/large-codebases#scope-and-plan-changes-that-span-packages)
...
](https://code.claude.com/docs/en/large-codebases#next-steps)
...
[Launch sessions from links](https://code.claude.com/docs/en/deep-links)[Troubleshoot installation and login](https://code.claude.com/docs/en/troubleshoot-install)
