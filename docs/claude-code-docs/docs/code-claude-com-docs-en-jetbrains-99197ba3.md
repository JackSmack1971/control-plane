...
fetched_at: "2026-07-12T00:15:35.142Z"
---
...
If `claude` is installed somewhere your IDE can’t find, set the full path in the plugin’s [Claude command setting](https://code.claude.com/docs/en/jetbrains#general-settings). Claude Code works with any paid Claude subscription (Pro, Max, Team, or Enterprise) or a Claude Console account, and no API key is required. You’ll be prompted to [log in](https://code.claude.com/docs/en/authentication#log-in-to-claude-code) the first time you run `claude`.
...
[Visual Studio Code](https://code.claude.com/docs/en/vs-code)[Security guidance plugin](https://code.claude.com/docs/en/security-guidance)
