...
- Pre-mutation file evidence is an explicit, schema-valid baseline of the declared write set.
- Committed inventory and package manifests use deterministic SHA-256 evidence; generated and mutable run outputs are excluded where declared.
